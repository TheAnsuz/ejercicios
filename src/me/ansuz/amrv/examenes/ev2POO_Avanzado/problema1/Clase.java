...
public class Clase implements Comparator<Alumno> {
    ...
    /**
     * Obtiene un alumno del curso usando su nombre completo, teniendo en cuenta
     * las mayusculas y minusculas, si no lo encuentra tira una excepcion
     *
    ...
    /**
     * Obtiene todas las medias de todos los alumnos en una asignatura
     * especifica
     *
