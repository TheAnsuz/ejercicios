...
public class Clave {
	...
	/**
	 * Obtiene el nivel de seguridad numerico de una clave, perfecto para ser usado
	 * internamente
	 * 
	 * @param password la clave de la cual se va a comprobar el nivel de seguridad
	 * @return un numero entre 1 y 3 indicando la seguridad de la clave (cuanto mas
	 *         alto mayor)
	 */
