...
public class Operador {
    ...
    public static boolean contieneSimbolos(String texto) {
        for (int i = 0; i < texto.length(); i++) {
            if (!Character.isLetterOrDigit(texto.charAt(i)))
                // Evita que cuente los caracteres de separacion como simbolos ya que son espacios
                return (!Character.isWhitespace(texto.charAt(i)));
        }
        return false;
    }
     ...
     * normalizado, si la cadena es menor que este numero estirara el ultimo
     * caracter
    ...
    /**
     * Convierte la cadena de texto crudo en una cadena de texto preparada para
     * ser mostrada en pantalla al usuario de una manera mas clara y praprada,
     * entre otras cosas convierte cada inicial de palabra en su version
    ...
    /**
     * Convierte el valor numerico de una clave en un texto representando su
     * nivel de seguridad
     *
