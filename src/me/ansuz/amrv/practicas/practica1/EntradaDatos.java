...
public class EntradaDatos {
	 ...
	 * @param enunciado el texto que mostrará la consola para solicitad los datos.
	 */
	...
	/**
	 * Obtiene un texto formateado dado el enunciado y la longitu minima que debe de
	 * tener la cadena de texto
	 *
	 * @param enunciado  lo que se mostrara en la consola para pedir el texto
	 * @param caracteres la longitud minima obligatoria que debe de tener la cadena
	 ...
	 *
	 * @param enunciado el texto que se mostrara antes de introducir la respuesta
	...
	public static String getDni(String enunciado) {
		...
		do {
			...
			if (valor.equalsIgnoreCase("00000000"))
			...
			if (!valido)
				System.out.println("El DNI debe de ser numerico");
		} while (!valido);
		return valor;
	}

	//===================================================================================================================
//					OBSOLETO PORQUE EL DNI DEBE DE PODER EMPEZAR POR 0
//	/**
...
//===================================================================================================================
	...
	/**
	 * Obtiene una fecha introucida por el usuario, dando el enunciado y la fecha
	 * maxima que puede ser dada
	 *
