...
public class Alumno implements Comparable<Alumno> {
	 ...
	 * alumno
	 *
	 * @return valor doble con la media entre todas las medias de las asignaturas
	 */
	...
	/**
	 * Obtiene una asignatura que el alumno curse, ignorando las mayusculas, si el
	 * alumno no cursa la asignatura, se tirara una excepcion
	 *
